...
class TestReplyKeyboardMarkup(object):
    ...
    def test_to_dict(self, reply_keyboard_markup):
        ...
        assert (reply_keyboard_markup_dict['keyboard'][0][0] == reply_keyboard_markup.keyboard[0]
                [0].to_dict())
        assert (reply_keyboard_markup_dict['keyboard'][0][1] == reply_keyboard_markup.keyboard[0]
                [1].to_dict())
        assert (
